...
if [[ $1 == '1' ]];
then
input='input_files_ylide_h_splits_0.txt'
output='out_ylide_h_0'
elif [[ $1 == '2' ]];
then
input='input_files_ylide_h_splits_1.txt'
output='out_ylide_h_1'
elif [[ $1 == '3' ]];
then 
input='input_files_ylide_h_splits_2.txt'
output='out_ylide_h_2'
elif [[ $1 == '4' ]];
then 
input='input_files_ylide_h_splits_3.txt'
output='out_ylide_h_3'
else
